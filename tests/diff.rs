...
//                 0,
//                 Dynamic::Nested(RenderedDiff {
//                     statics: vec!["<p>Count is high</p>".to_string(),
// "".to_string()],                     dynamics: HashMap::from_iter([(0,
// Dynamic::String("".to_string()))]),                 })
//             )])
//         }
//     );
...
//                         0,
//                         Dynamic::Nested(RenderedDiff {
//                             statics: vec!["<p>Count is very
// high!</p>".to_string()],                             dynamics:
// HashMap::default(),                         })
//                     )]),
//                 })
//             )])
